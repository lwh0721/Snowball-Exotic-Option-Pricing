...
class Pricing():
    ...
    def Snowball_price(Nsims, Nsteps,sim_path, T, S0, r, sigma, coupon_rate, knock_in, knock_out, principle_value):
        ...
        print('Probability of Knock-out is %.2f' % (out_time/Nsims*100), '%')
        print('Probability of Knock-in, No Knock-out is %.2f' % (in_time/Nsims*100), '%')
        print('Probability of Neither knock-in nor knock-out is %.2f' % (no_time/Nsims*100), '%')
        
        print('Probability of earning profit is %.2f' % ((out_time + no_time)/Nsims*100), '%')
        print('Probability of loss is %.2f' % (in_time/Nsims*100), '%')
